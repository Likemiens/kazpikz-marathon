...
- Основной demo canvas переведён на 9:16. Портретный browser smoke повторяется после каждого UI-прохода; release-геометрию всё равно нужно проверить на фактической Android-панели.
