...
Подключить настоящий native submit: success только после ACK. Восемь фраз вставляются
и редактируются; две исходные остаются быстрыми действиями. Реальные данные запрещены до privacy approval. Базовый layout
...
FR-05/07/10/14, AC-09–10/14. Утвердить локали/восемь фраз/словарь и правила данных.
